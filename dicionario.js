function carregaDicionario() {      /*a function serve para armazenar uma variável que será chamada depois*/
    let biografias = {
        bio01: {
            nome: "Estamira Gomes de Sousa",
            imagem: "https://images.squarespace-cdn.com/content/v1/542f32e5e4b00b15579d8a9b/1412820200380-0XOCPSFUN8YCMU8OPGZ9/12.jpg?",
            descricao: "Protagonista de um documentário com o seu próprio nome, Estamira Gomes de Sousa foi uma mulher diagnosticada como esquizofrênica, e que viveu há mais de 20 anos recolhendo seu sustento no lixão do aterro sanitário do Jardim Gramacho na Baixada Fluminense, no Rio de Janeiro. Tornou-se famosa pelo seu discurso filosófico, uma mistura de extrema lucidez e loucura, que abrangia temas como: a vida, Deus, o trabalho e reflexões existenciais acerca de si mesma e da sociedade dos homens. Ela acreditava ter a missão de trazer os princípios éticos básicos para as pessoas que viviam fora do lixo onde ela viveu por 22 anos. Para ela, o verdadeiro lixo são os valores falidos em que vive a sociedade.",
            citacao: "A minha missão, além de ser a Estamira, é mostrar a verdade, capturar a mentira e tacar na cara."
        },

        bio02: { /*configurando objetos através da chaves bio*/
            nome: "Lélia Gonzalez",
    ...
    let content = document.getElementById("content"); /*a variável content aqui é a mesma class da section no arquivo html*/

    for (let bio in biografias) {
        content.innerHTML += /* estamos dizendo que o content irá receber um trecho html abaixo*/
            '<div class="div">' +  /*começamos a inserir tudo o que está dentro da section content do html */
            '<img src="' + biografias[bio].imagem + '"/>' +
            '<details>' + /*details é o efeito sanfona ACCORDION*/
